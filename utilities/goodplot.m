...
if  ~ADJUST_FIG_ONLY
    ...
    set(H,'FontName',fonttype,'FontSize', fontsize-1);
...
for i=1:length(h)
    if strcmp(h(i).String{1},'data1')  % indicates automatically generated legend
        set(h(i),'Visible','off');
    else 
...
set(gcf,'PaperPosition',[margin(1) margin(2) papersize(1)+0.2-margin(1) papersize(2)-0.01-margin(2)]);
