% [ A, B, C, D ,state_trim,control_trim ] = JACOBIAN_F16( velocity, altitude, xcg ) 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                    Jacobian_F16.m                       %%
%%                                                         %%
...
function [ A, B, C, D,state_trim,control_trim ] = jacobian_f16_rev( velocity, altitude, xcg ) 

%---- trim the flight ----
[ state_trim, control_trim ] = find_trim_rev(velocity, altitude, xcg );
state_dot_trim = zeros( length(state_trim), 1 );
state_dot_trim(10) = velocity; % assume flying towards the north?
...
%   is reached.                                         %
%---------------------------------------------------------
A = jacobian_A_rev(state_trim, state_dot_trim, control_trim, xcg );
B = jacobian_B_rev( state_trim, state_dot_trim, control_trim, xcg );
C = jacobian_C_rev( state_trim, state_dot_trim, control_trim, xcg );
D = jacobian_D_rev( state_trim, state_dot_trim, control_trim, xcg );
