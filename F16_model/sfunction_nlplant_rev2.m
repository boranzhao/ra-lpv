...
% edited by Pan Zhao:
% 06/06/2020: added disturbance to the derivative of angle-of-attack and
% pitch-rate

function [ sys, x0, str, ts ] = sfunction_nlplant_rev2( t, x , u, flag, state_trim, xcg)
