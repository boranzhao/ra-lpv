...
function D_reduce = jacobian_D_rev( state_eq, state_dot_eq, control_eq, xcg )
...
ij = ij + 1;
answer = answer'; %%% added by Pan Zhao on 01/05/2020: I feel the transpose operation is wrong.
D_org = answer;
